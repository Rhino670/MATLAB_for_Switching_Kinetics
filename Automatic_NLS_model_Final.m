...
A = 0.9; % A normalization constant for fitting the NLS distribution to the experimental data
...
ngrow=Avramin; % this sets the exponent "n" in the integral to the Avrami n constant from the experimental curve
